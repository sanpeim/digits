...
public class GradeLevel {
  ...
  public static List<String> getLevel(String level) {
    List<String> levels = GradeLevel.getNameList();
    if (isType(level)) {
      levels.add(level);
    }
    return levels;
  ...
  public static boolean isType(String level) {
    return GradeLevel.getNameList().contains(level);
  }
  ...
  static {
    ...
    allLevels.add(new GradeLevel(5L, "N/A"));
  }
